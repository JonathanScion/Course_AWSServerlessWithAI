# PowerShell Script to Destroy ALL AWS Infrastructure (Non-Interactive)
...
Write-Host "Destroying ALL AWS resources..." -ForegroundColor Yellow
Write-Host ""
...
if ($failCount -gt 0) {
    Write-Host "Some resources may still exist. Check AWS Console." -ForegroundColor Yellow
    exit 1
} else {
